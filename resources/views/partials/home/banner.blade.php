...
<script src="https://dat-gui.googlecode.com/git/build/dat.color.min.js"></script>
<script>
    $(function () {
        ...
        var utils = {
            ...
            curveThroughPoints: function (points, ctx) {
                ...
                for (i = 1, n = points.length - 2; i < n; i++) {if (window.CP.shouldStopExecution(0)) break;
        ...
        var Tentacle = function (options) {
            ...
            for (var i = 0; i < this.length; i++) {if (window.CP.shouldStopExecution(1)) break;
        ...
        Tentacle.prototype = {
            ...
            move: function (x, y, instant) {
                ...
                if (instant) {
                    ...
                    for (i = 1; i < this.length; i++) {if (window.CP.shouldStopExecution(2)) break;
            ...
            update: function () {
                ...
                for (i = 1, j = 0; i < this.length; i++, j++) {if (window.CP.shouldStopExecution(3)) break;
        ...
        var sketch = Sketch.create({
            ...
            setup: function () {
                ...
                for (var i = 0; i < 100; i++) {if (window.CP.shouldStopExecution(4)) break;
            ...
            update: function () {
                ...
                for (var i = 0, n = settings.tentacles; i < n; i++) {if (window.CP.shouldStopExecution(5)) break;
            ...
            draw: function () {
                ...
                for (var i = 0, n = settings.tentacles; i < n; i++) {if (window.CP.shouldStopExecution(6)) break;
